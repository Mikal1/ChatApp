...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Contatcs> options=
                ...
                .setQuery(UsersRef,Contatcs.class)
                .build();

        FirebaseRecyclerAdapter<Contatcs,FindFriendViewHolder> adapter=
                new FirebaseRecyclerAdapter<Contatcs, FindFriendViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull FindFriendViewHolder holder, final int position, @NonNull Contatcs model) {
